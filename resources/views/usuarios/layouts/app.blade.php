            ...
            <div class="col-md-3">
                ...
                <ul class="list-group">
                    ...
                    @if(Auth::user()->level>=2)
                        ...
                        <li class="list-group-item text-center"><a href="{!! url('/painel/criar-usuario') !!}">->Criar usuario</a></li>
                        <li class="list-group-item text-center"><a href="{!! url('/painel/listar-usuario') !!}">->Listar Usuários</a></li>
                     @endif
                </ul>
            </div>
